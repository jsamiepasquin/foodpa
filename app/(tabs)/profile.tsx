    ...
    >
      <ScrollView style={{ flex: 1, width: '100%' }}>
        ...
        <View style={profileStyle.mainContainer}>
          ...
          <View style={profileStyle.profileSection}>
            <ProfileSectionInfo label="Height" value={String(healthData.height)} mode={mode} setValue={(value) => setHealthData({ ...healthData, height: Number(value) })} inputType={"numeric"} />
            <ProfileSectionInfo label="Weight" value={String(healthData.weight)} mode={mode} setValue={(value) => setHealthData({ ...healthData, weight: Number(value) })} inputType={"numeric"} />
            <ProfileSectionInfo label="Waist Circumference" value={String(healthData.waistCircumference)} mode={mode} setValue={(value) => setHealthData({ ...healthData, waistCircumference: Number(value) })} inputType={"numeric"} />
            <ProfileSectionInfo label="Hip Circumference" value={String(healthData.hipCircumference)} mode={mode} setValue={(value) => setHealthData({ ...healthData, hipCircumference: Number(value) })} inputType={"numeric"} />
          </View>
          <Text style={profileStyle.sectionTitle}>Vital Statistics</Text>
          <View style={profileStyle.profileSection}>
            <ProfileSectionInfo label="Body Temperature" value={String(healthData.bodyTemperature)} mode={mode} setValue={(value) => setHealthData({ ...healthData, bodyTemperature: Number(value) })} inputType={"numeric"} />
            <ProfileSectionInfo label="Blood Pressure" value={healthData.bloodPressure} mode={mode} setValue={(value) => setHealthData({ ...healthData, bloodPressure: value })} inputType={"numeric"} />
            <ProfileSectionInfo label="Heart Rate" value={healthData.heartRate} mode={mode} setValue={(value) => setHealthData({ ...healthData, heartRate: value })} inputType={"numeric"} />
            <ProfileSectionInfo label="Blood Sugar Level" value={healthData.bloodSugar} mode={mode} setValue={(value) => setHealthData({ ...healthData, bloodSugar: value })} inputType={"numeric"} />
            <ProfileSectionInfo label="Cholesterol Levels" value={healthData.cholesterolLevels} mode={mode} setValue={(value) => setHealthData({ ...healthData, cholesterolLevels: value })} inputType={"numeric"} />
          </View>
